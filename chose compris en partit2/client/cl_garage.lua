    ...
    while true do 
        ...
        if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
            for k in pairs(cfg_police.Position.RentreVehicule) do 
                ...
                if dist <= 5.0 then 
                    wait = 0
                    DrawMarker(cfg_police.MarkerType, pos[k].x, pos[k].y, pos[k].z,0.0, 0.0, 0.0, -90.0, 0.0, 0.0, 2.0, 2.0, 2.0, 69, 112, 246, 150, false, true, 2, true, false, false, false)  
                end
                        ...
                        for i = 1,9 do
                            if DoesExtraExist(pVeh, i) then
                                if IsVehicleExtraTurnedOn(pVeh, i) then
                                    ...
                                    RageUI.Button("~b~Activer~s~ l'extra "..i, nil, {}, true, {
                                        onSelected = function()
